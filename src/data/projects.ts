...
export const projects: Project[] = [
  {
    ...
    image: {
      src: "/projects/trace-profile-live.jpg",
      alt: "Trace profile screen showing visited countries map, travel stats, My Guide, and upcoming trips",
      width: 472,
      height: 1024,
    },
    featured: true,
  ...
  {
    slug: "gallery-extraction",
    title: "Photo Metadata Collector",
    subtitle: "Gallery → Dataset",
    year: "2026",
    type: "Privacy-preserving browser tool",
    role: "Solo developer",
    status: "Live · client-side only",
    description:
      "Turning a photo library into usable data usually means installing ExifTool or uploading files to someone else's server. This browser tool extracts EXIF and sidecar metadata from photos, Apple Photos exports, or Google Takeout folders — locally, with nothing uploaded — and packages the result as a queryable dataset.",
    highlights: [
      "Reads photos in-browser with ExifTool compiled to WebAssembly; source media never leaves the device",
      "Matches Google JSON and Apple XMP sidecars from Takeout or Photos exports",
      "Full or limited metadata modes, so GPS, filenames, and free text can be omitted before sharing",
      "Downloads a ZIP with SQLite, CSV, JSONL records, a coverage manifest, and starter SQL queries",
      "No install required: share a GitHub Pages link and recipients extract datasets in their own browser",
    ],
    skills: ["TypeScript", "React", "Vite", "WebAssembly", "SQLite", "GitHub Pages"],
    liveUrl: "https://kkam717.github.io/gallery-extraction/",
    githubUrl: "https://github.com/kkam717/gallery-extraction",
    image: {
      src: "/projects/gallery-extraction.png",
      alt: "Photo Metadata Collector homepage with local folder drop zone and export options",
      width: 1280,
      height: 900,
    },
    featured: false,
